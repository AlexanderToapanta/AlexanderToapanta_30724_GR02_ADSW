(function () {
    ...
    form.addEventListener('submit', asignarMembresia);
    ...
    async function asignarMembresia(evento) {
        ...
        try {
            ...
            await enviar('crear', datos);
            mostrarEstado('Membresia asignada correctamente.', 'ok');
            form.reset();
            usarFechaActual();
            sugerirPrecio();
            await cargarListado();
